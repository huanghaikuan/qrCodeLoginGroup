...
public class TwoDimensionCode {  
	//二维码 SIZE
	private static final int CODE_IMG_SIZE = 234;
	// LOGO SIZE (为了插入图片的完整性，我们选择在最中间插入，而且长宽建议为整个二维码的1/5至1/4)
    private static final int INSERT_IMG_SIZE = CODE_IMG_SIZE/5;  
      
    public static void main(String[] args) {  
        String createImgPath = "F:/aaaaaaaaaaaaaallsQrCode.png";  
        String encoderContent = "www.baidu.com"; 
        String insertLogoImgPath = "F:/llslogo.png";
        TwoDimensionCode handler = new TwoDimensionCode();  
        handler.encoderQRCode(encoderContent, createImgPath, "png", insertLogoImgPath);
        
        System.out.println("========encoder success");  
        String decoderContent = handler.decoderQRCode(createImgPath);  
